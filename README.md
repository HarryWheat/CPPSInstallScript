...
To use the installation scripts  run  both these command as root. (first make sure you have curl by doing ' sudo apt install curl ' and then restarting the VPS/Server)
```bash
